...
#the function will destroy df_to_interpolate
    ...
    with Pool(6) as p:
        ...
        df_to_interpolate[col_of_average]=pd.concat(p.map(partial(interpolate_rt_wrapped,gpb_sorted=gpb_sorted,col_of_date_int=col_of_date_int,col_of_average=col_of_average,col_of_boundary=col_of_boundary,col_of_decay=col_of_decay,interpolate_boundary=interpolate_boundary),df_to_interpolate_split))
...
m_total=success_rate(m_total,['char_3_y','char_4_y','char_32'],m_train)
...
#interpolate inside the boundary
...
m_test['act_date_int_group_1_rt'].fillna(fillna_num,inplace=True)#since we are not just using m_test_gp
...
#interpolate outside the boundary
m_test_gp=m_test_gp[['group_1','act_date_int']]
m_test_gp=interpolate_rt_df(m_test_gp,m_train,'group_1','act_date_int','act_date_int_group_1_rt','group_1_rt','group_act_size')
del m_test['act_date_int_group_1_rt']
m_test=m_test.merge(m_test_gp,how='left',on=['group_1','act_date_int'])
...
use_col_wo=['activity_category', 'char_1_x', 'char_10_x', 'char_2_x','char_3_x', 'char_4_x', 'char_5_x', 'char_6_x', 'char_7_x', 'char_8_x','char_9_x', 'char_1_y', 'char_2_y','char_3_y', 'char_4_y', 'char_5_y', 'char_6_y', 'char_7_y', 'char_8_y','char_9_y', 'char_10_y', 'char_11', 'char_12', 'char_13', 'char_14','char_15', 'char_16', 'char_17', 'char_18', 'char_19', 'char_20','char_21', 'char_22', 'char_23', 'char_24', 'char_25', 'char_26','char_27', 'char_28', 'char_29', 'char_30', 'char_31', 'char_32','char_33', 'char_34', 'char_35', 'char_36', 'char_37', 'is_last_act', 'act_year', 'act_month', 'act_day', 'act_weekday','act_week_num', 'act_date_int', 'peo_date_int','char_6_y_prod_char_7_y']#, 'char_10_x_char_38_rt','char_6_y_char_7_y_char_32_char_18_rt', 'char_10_x_char_38_rt_s', 'char_10_x_char_38_rt_us','char_6_y_char_7_y_char_32_char_18_rt_s','char_6_y_char_7_y_char_32_char_18_rt_us','char_38',
######################################
