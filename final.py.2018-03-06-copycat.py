...
col_sample_tree=1
small_group_act_size=100000000
######################################
print('functions')
######################################
...
use_col_wo=['activity_category', 'char_1_x',  'char_2_x','char_3_x', 'char_4_x', 'char_5_x', 'char_6_x', 'char_7_x', 'char_8_x','char_9_x', 'char_1_y', 'group_1','char_2_y','char_3_y', 'char_4_y', 'char_5_y', 'char_6_y', 'char_7_y', 'char_8_y','char_9_y', 'char_10_y', 'char_11', 'char_12', 'char_13', 'char_14','char_15', 'char_16', 'char_17', 'char_18', 'char_19', 'char_20','char_21', 'char_22', 'char_23', 'char_24', 'char_25', 'char_26','char_27', 'char_28', 'char_29', 'char_30', 'char_31', 'char_32','char_33', 'char_34', 'char_35', 'char_36', 'char_37', 'act_year', 'act_month', 'act_day', 'act_weekday']#, 'char_10_x_char_38_rt','char_6_y_char_7_y_char_32_char_18_rt', 'char_10_x_char_38_rt_s', 'char_10_x_char_38_rt_us','char_6_y_char_7_y_char_32_char_18_rt_s','char_6_y_char_7_y_char_32_char_18_rt_us','is_last_act', 'act_week_num', ,'char_6_y_prod_char_7_y','char_10_x', 'act_date_int','peo_date_int','char_38',
######################################
print('df_train_gp')
######################################
...
if not kaggle_output:
    print(roc_auc_score(local_outcome_gp,df_test_gp['act_date_int_group_1_rt']))
    print(roc_auc_score(local_outcome_wo,bst_wo.predict(dtest_wo)))
    print(roc_auc_score(np.concatenate((local_outcome_gp,local_outcome_wo)),np.concatenate((df_test_gp['act_date_int_group_1_rt'],(2*(bst_wo.predict(dtest_wo)-0.5))**confidence_wo/2+0.5))))
else:
    pred_gp=df_test_gp['act_date_int_group_1_rt']
