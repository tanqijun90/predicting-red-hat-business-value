...
def interpolate_rt(df_sorted_by_date,col_of_date_int,col_of_average,col_of_boundary,date_int):
    if date_int > df_sorted_by_date[col_of_date_int].iloc[-1]:
        return df_sorted_by_date[col_of_average].iloc[-1]*0.95+df_sorted_by_date[col_of_boundary].iloc[-1]*0.05
    if date_int < df_sorted_by_date[col_of_date_int].iloc[0]:
        return df_sorted_by_date[col_of_average].iloc[0]*0.95+df_sorted_by_date[col_of_boundary].iloc[0]*0.05
...
use_col_gp=['activity_category', 'char_1_x', 'char_10_x', 'char_2_x','char_3_x', 'char_4_x', 'char_5_x', 'char_6_x', 'char_7_x', 'char_8_x','char_9_x', 'char_1_y', 'group_1', 'char_2_y','char_3_y', 'char_4_y', 'char_5_y', 'char_6_y', 'char_7_y', 'char_8_y','char_9_y', 'char_10_y', 'char_11', 'char_12', 'char_13', 'char_14','char_15', 'char_16', 'char_17', 'char_18', 'char_19', 'char_20','char_21', 'char_22', 'char_23', 'char_24', 'char_25', 'char_26','char_27', 'char_28', 'char_29', 'char_30', 'char_31', 'char_32','char_33', 'char_34', 'char_35', 'char_36', 'char_37', 'char_38','is_last_act', 'act_year', 'act_month', 'act_day', 'act_weekday','act_week_num', 'act_date_int', 'peo_date_int','char_6_y_prod_char_7_y','act_date_int_group_1_rt', 'char_10_x_char_38_rt','char_6_y_char_7_y_char_32_char_18_rt', 'group_1_rt','char_6_y_char_7_y_char_32_char_18_rt_s','char_6_y_char_7_y_char_32_char_18_rt_us']

use_col_wo=['activity_category', 'char_1_x', 'char_10_x', 'char_2_x','char_3_x', 'char_4_x', 'char_5_x', 'char_6_x', 'char_7_x', 'char_8_x','char_9_x', 'char_1_y', 'char_2_y','char_3_y', 'char_4_y', 'char_5_y', 'char_6_y', 'char_7_y', 'char_8_y','char_9_y', 'char_10_y', 'char_11', 'char_12', 'char_13', 'char_14','char_15', 'char_16', 'char_17', 'char_18', 'char_19', 'char_20','char_21', 'char_22', 'char_23', 'char_24', 'char_25', 'char_26','char_27', 'char_28', 'char_29', 'char_30', 'char_31', 'char_32','char_33', 'char_34', 'char_35', 'char_36', 'char_37', 'is_last_act', 'act_year', 'act_month', 'act_day', 'act_weekday','act_week_num', 'act_date_int', 'peo_date_int','char_6_y_prod_char_7_y']#, 'char_10_x_char_38_rt','char_6_y_char_7_y_char_32_char_18_rt','char_6_y_char_7_y_char_32_char_18_rt_s','char_6_y_char_7_y_char_32_char_18_rt_us','char_38',
######################################
...
#How to deal with 'act_date_int_group_1_rt_optimistic'
