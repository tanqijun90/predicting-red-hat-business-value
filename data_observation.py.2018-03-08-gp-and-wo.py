...
#         if col1>col2:
#             print(col1,'  ',col2)
#             m_total=success_rate(m_total,[col1,col2],m_train)

m_train=m_total.iloc[:len(act_train)]
for col2 in available_features:
    print(col2)
    m_total=success_rate(m_total,['char_5_y','char_7_y','char_32',col2],m_train)
...
#        print(col,' AUC: ',roc_auc_score(local_outcome_wo,df_test_wo[col]))
#char_6_y_char_38_rt  AUC:  0.6180590521495533
#char_7_y_char_5_y_rt  AUC:  0.6230330035833669
#char_7_y_char_6_y_rt  AUC:  0.6238117766318336
#char_7_y_char_38_rt  AUC:  0.625534035271204
#char_7_y_char_2_y_rt  AUC:  0.5960062216457271
#char_8_y_char_7_y_rt  AUC:  0.6194151424133544
#char_7_y_char_5_y_char_32_rt  AUC:  0.6329153168989337
#char_7_y_char_5_y_char_24_rt  AUC:  0.6328282026378187
#char_7_y_char_5_y_char_25_rt  AUC:  0.6326927788519946
#char_6_y_char_38_char_7_y_rt  AUC:  0.6306211162689023
